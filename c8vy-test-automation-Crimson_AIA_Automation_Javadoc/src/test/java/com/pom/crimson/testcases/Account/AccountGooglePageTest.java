...
/**
 * This class contains test methods to test Menus in Profile screen via Google Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class AccountGooglePageTest extends BaseFixture {
	LoginPage loginPage;
	HomePage homePage;
	LogAssert logAssert;
	...
	@Test(enabled=true, priority = 82, testName = "Verify all the menus are working in Account screen via Gmail", description = "Verify all the menus are working in Account screen via Email")
		public void VerifyManusInAccountScreenviaGoogle() throws InterruptedException, IOException
		{ 
