...
/**
 * This class contains test methods to test <b>Talk to AIA agent</b> Page via Apple Login 
 *
...
public class TalktoAIAAgentApplePageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 147, testName = "Verify Talk to AIA Agent Screen appears for Login via Apple for Select AIA Customer Yes With Email Option", description = "Verify Talk to AIA Agent Screen appears for Login via Apple for Select AIA Customer Yes With Email Option")
	public void SubmitTalktoAIAAgentSelectAIACustomerYes_WithEmailOption_LoginViaApple() throws InterruptedException, IOException
	{ 
		ExtentReportManager.getTest().log(Status.INFO, "Verify Talk to AIA Agent Screen appears for Login via Apple");
	...
	@Test(enabled=true, priority = 148, testName = "Verify Talk to AIA Agent Screen appears for Login via Apple for Select AIA Customer No With Email Option", description = "Verify Talk to AIA Agent Screen appears for Login via Apple for Select AIA Customer No With Email Option")
	public void SubmitTalktoAIAAgentSelectAIACustomerNo_WithEmailOption_LoginViaApple() throws InterruptedException, IOException
	{ 
		ExtentReportManager.getTest().log(Status.INFO, "Verify Talk to AIA Agent Screen appears for Login via Apple");
		loginPage.Takepic_Recvideo();
		 if (loginPage.isElementDisplayed("Skip"))
	...
	@Test(enabled=true, priority = 149, testName = "Verify Talk to AIA Agent Screen appears for Login via Apple for Select AIA Customer Yes With Phone Option", description = "Verify Talk to AIA Agent Screen appears for Login via Apple for Select AIA Customer Yes With Phone Option")
	public void SubmitTalktoAIAAgentSelectAIACustomerYes_WithPhoneOption_LoginViaApple() throws InterruptedException, IOException
	{ 
		ExtentReportManager.getTest().log(Status.INFO, "Verify Talk to AIA Agent Screen appears for Login via Apple");
		loginPage.Takepic_Recvideo();
		 if (loginPage.isElementDisplayed("Skip"))
	...
	@Test(enabled=true, priority = 150, testName = "Verify Talk to AIA Agent Screen appears for Login via Apple for Select AIA Customer No With Phone Option", description = "Verify Talk to AIA Agent Screen appears for Login via Apple for Select AIA Customer No With Phone Option")
	public void SubmitTalktoAIAAgentSelectAIACustomerNo_WithPhoneOption_LoginViaApple() throws InterruptedException, IOException
	{ 
		ExtentReportManager.getTest().log(Status.INFO, "Verify Talk to AIA Agent Screen appears for Login via Apple");
		loginPage.Takepic_Recvideo();
		 if (loginPage.isElementDisplayed("Skip"))
