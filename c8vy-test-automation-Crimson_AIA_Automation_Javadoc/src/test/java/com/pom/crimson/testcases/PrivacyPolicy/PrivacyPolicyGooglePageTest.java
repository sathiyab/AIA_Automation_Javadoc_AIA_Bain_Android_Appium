...
/**
 * This class contains test methods to test <b>Privacy policy</b> page via Google Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class PrivacyPolicyGooglePageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 241, testName = "Verify Privacy Statement Screen appears for Login via Google", description = "Verify Privacy Statement Screen appears for Login via Google")
	public void VerifyPrivacyStatement_LoginViaGoogle() throws InterruptedException, IOException
	{ 
		ExtentReportManager.getTest().log(Status.INFO, "Verify Privacy Statement Screen appears for Login via Google");
