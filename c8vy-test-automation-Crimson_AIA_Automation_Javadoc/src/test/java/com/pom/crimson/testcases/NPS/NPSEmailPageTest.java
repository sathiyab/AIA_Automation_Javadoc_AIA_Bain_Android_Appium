...
/**
 * This class contains test methods to test <b>NPS</b> functionality via Email Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class NPSEmailPageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 151, testName = "Verify NPS for (Scale 1 -6) Login via Email", description = "Verify NPS for (Scale 1 -6) Login via Email")
	public void VerifyNPS_Scale1to6_LoginViaEmail() throws InterruptedException, IOException
	{ 
	ExtentReportManager.getTest().log(Status.INFO, "Verify NPS appears for Login via eMail");
	...
	NP.scrollNPS();
	logAssert.assertTrue(NP.isElementDisplayed("NPS"),"NPS menu appears");
	NP.ClickNPS();
	logAssert.assertTrue(NP.isElementDisplayed("Tell us what you think"),"Tell us what you think appears");
	logAssert.assertTrue(NP.isElementDisplayed("On a scale of 1 to 10, how likely are you to recommend Crimson to a friend or colleague?"),"On a scale of 1 to 10, how likely are you to recommend Crimson to a friend or colleague? appears");
	NP.Click1();
	logAssert.assertTrue(NP.isElementDisplayed("1"),"Scale 1 is clicked");
	NP.ClickNext();
	logAssert.assertTrue(NP.isElementDisplayed("What went wrong?"),"What went wrong? appears");
	NP.EnterFeedback_Scale1to6();
	NP.clickSubmit();

	logAssert.assertTrue(NP.isElementDisplayed("Thank you for your feedback!"),"Thank you for your feedback! appears");
	...
	@Test(enabled=true, priority = 152, testName = "Verify NPS for (Scale 7 -8) Login via Email", description = "Verify NPS for (Scale 7 -8) Login via Email")
	public void VerifyNPS_Scale7to8_LoginViaEmail() throws InterruptedException, IOException
	{ 
		ExtentReportManager.getTest().log(Status.INFO, "Verify NPS appears for Login via eMail");
		loginPage.Takepic_Recvideo();
		 if (loginPage.isElementDisplayed("Skip"))
		...
		NP.clickSubmit();
		logAssert.assertTrue(OBP.isElementDisplayed("Thank you for your feedback!"),"Thank you for your feedback! appears");
		logAssert.assertTrue(OBP.isElementDisplayed("Your feedback will help us improve Crimson experience."),"Your feedback will help us improve Crimson experience appears");
		Thread.sleep(1000);
	...
	@Test(enabled=true, priority = 153, testName = "Verify NPS for (Scale 9 -10) Login via Email", description = "Verify Contact Us Screen appears for Login via Email")
	public void VerifyNPS_Scale9to10_LoginViaEmail() throws InterruptedException, IOException
	{
		ExtentReportManager.getTest().log(Status.INFO, "Verify NPS appears for Login via eMail");
		loginPage.Takepic_Recvideo();
		 if (loginPage.isElementDisplayed("Skip"))
