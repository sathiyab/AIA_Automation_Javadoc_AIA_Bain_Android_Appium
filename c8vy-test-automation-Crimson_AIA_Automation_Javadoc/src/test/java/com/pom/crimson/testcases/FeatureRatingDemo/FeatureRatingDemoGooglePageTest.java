...
/**
 * This class contains test methods to test <b>Feature Rating</b> functionality via Google Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class FeatureRatingDemoGooglePageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 175, testName = "Verify Feature rating demo via Google", description = "Verify Feature rating demo via Email")
	public void verifyFeatureRatingLoginWithGmail() throws Exception
	{
	...
	@Test(enabled=true, priority = 176, testName = "Verify Feature rating demo with Not Now option via Google", description = "Verify Feature rating demo with Not Now option via Google")
