...
/**
 * This class contains test methods to test <b>Contact us</b> page via Facebook Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class ContactUsFacebookPageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 113, testName = "Verify Contact Us Screen appears for Login via Facebook", description = "Verify Contact Us Screen appears for Login via Facebook")
	public void VerifyContactUs_LoginViaFacebook() throws InterruptedException, IOException
	{ 
