...
/**
 * This class contains test methods to test <b>Profile</b> Screen Elements via Facebook Login 
 * 
 * @author Balaji.Sridharan 
 */
public class ProfileFacebookPageTest extends BaseFixture {
	LoginPage loginPage;
	HomePage homePage;
	LogAssert logAssert;
	...
	@Test(enabled=true, priority = 202, testName = "Verify Headings and Profile details exists in Manage Profile via Facebook", description = "Verify Headings and Profile details exists in Manage Profile via Facebook")
	public void VerifyProfileDetailsViaFacebook() throws InterruptedException, IOException
	{ 
   ...
   // logAssert.assertTrue(MP.isElementDisplayed("testb4061@gmail.com"),"Email-id is correct");
    logAssert.assertTrue(MP.isElementDisplayed(Constants.FBTestUser),"Email-id is correct");
