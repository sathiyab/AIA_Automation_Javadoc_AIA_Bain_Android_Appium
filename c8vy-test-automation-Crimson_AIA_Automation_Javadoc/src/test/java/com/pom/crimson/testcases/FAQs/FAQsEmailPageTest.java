...
/**
 * This class contains test methods to test <b>FAQ</b> Screen functions via Email Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class FAQsEmailPageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 116, testName = "Verify FAQs Screen appears for Login via eMail", description = "Verify Contact Us Screen appears for Login via eMail")
	public void VerifyFAQs_LoginViaEmail() throws InterruptedException, IOException
	{ 
