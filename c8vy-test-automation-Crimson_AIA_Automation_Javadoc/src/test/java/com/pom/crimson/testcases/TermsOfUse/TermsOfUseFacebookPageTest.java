...
/**
 * This class contains test methods to test <b>Terms of use</b> Page via Facebook Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class TermsOfUseFacebookPageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 246, testName = "Verify Terms Of Use Screen appears for Login via Facebook", description = "Verify Terms Of Use Screen appears for Login via Facebook")
	public void VerifyTermsOfUse_LoginViaFacebook() throws InterruptedException, IOException
	{ 
		ExtentReportManager.getTest().log(Status.INFO, "Verify Terms Of Use Screen appears for Login via Facebook");
