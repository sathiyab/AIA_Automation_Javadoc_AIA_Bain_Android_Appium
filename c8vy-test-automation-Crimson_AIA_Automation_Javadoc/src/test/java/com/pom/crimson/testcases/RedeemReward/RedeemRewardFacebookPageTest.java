...
/**
 * This class contains test methods to test <b>Redeem reward</b> via Facebook Login 
 * 
 * @author Balaji.Sridharan 
 */
public class RedeemRewardFacebookPageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 164, testName = "Verify able to submit Redeem Reward for Login via Facebook", description = "Verify able to submit Redeem Reward for Login via Facebook")
	public void VerifyRedeemreward_LoginViaFacebook() throws InterruptedException, IOException
	{ 
		ExtentReportManager.getTest().log(Status.INFO, "Verify able to submit Redeem Reward for Login via Facebook");
