...
/**
 * This class contains test methods to test <b>FAQ</b> Screen functions via Apple Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class FAQsApplePageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 119, testName = "Verify FAQs Screen appears for Login via Apple", description = "Verify Contact Us Screen appears for Login via Apple")
	public void VerifyFAQs_LoginViaApple() throws InterruptedException, IOException
	{ 
