...
/**
 * This class contains test methods to test <b>Redeem reward</b> via Google Login 
 * 
 * @author Balaji.Sridharan 
 */
public class RedeemRewardGooglePageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 165, testName = "Verify able to submit Redeem Reward for Login via Google", description = "Verify able to submit Redeem Reward for Login via Google")
	public void VerifyRedeemreward_LoginViaGoogle() throws InterruptedException, IOException
	{ 
		ExtentReportManager.getTest().log(Status.INFO, "Verify able to submit Redeem Reward for Login via Google");
