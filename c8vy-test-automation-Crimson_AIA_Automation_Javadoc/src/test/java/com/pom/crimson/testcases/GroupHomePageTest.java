 ...
 * @author Indirani
 */
public class GroupHomePageTest extends BaseFixture {
	...
	//Verify already joined group functionality
	...
	//Verify Member Group functionality
	...
	//Verify Group Info functionality
	...
	//@Test(enabled=true, priority = 6,testName="Verify Invite functionality",description="User validate Shared Friends Group")
	public void verifySharedFriendsGroup() throws InterruptedException, IOException
	{
		...
		ExtentReportManager.getTest().log(Status.INFO,  "Clicking on Action Button");
		Thread.sleep(10000);
		logAssert.assertTrue(GP.isElementDisplayed("Invite friends to group (26/50)"),"Invite friends to group is displayed");
		GP.invfriendsGrp();
		logAssert.assertTrue(GP.isElementDisplayed("Copy"),"Copy is displayed");
	...
	//Verify Leave Group functionality
		@Test(enabled=true, priority = 7,testName="Verify Leave Group functionality",description="User validate Member Group")
		public void verifyMembersGroup() throws InterruptedException, IOException
		{
			...
			GP.leaveGrp();
			logAssert.assertTrue(GP.isElementDisplayed("Groups"),"Groups Screen is displayed");
			logAssert.assertAll();
		}
