...
/**
 * This class contains test methods to test <b>Feature Rating</b> functionality via Email Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class FeatureRatingDemoEmailPageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 171, testName = "Verify Feature rating demo via Email", description = "Verify Feature rating demo via Email")
	public void verifyFeatureRatingLoginWithEmail() throws Exception
	{
	...
	@Test(enabled=true, priority = 172, testName = "Verify Feature rating demo with Not Now option via Email", description = "Verify Feature rating demo with Not Now option via Email")
	public void verifyFeatureRatingLogin_NotNow_WithEmail() throws Exception
	{
			loginPage.Takepic_Recvideo();
			loginPage.skipIntroScreens();
			loginPage.LoginWithEmail();
