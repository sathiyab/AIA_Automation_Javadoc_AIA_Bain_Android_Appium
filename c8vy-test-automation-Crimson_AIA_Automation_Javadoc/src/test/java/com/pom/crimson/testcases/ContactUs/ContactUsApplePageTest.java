...
/**
 * This class contains test methods to test <b>Contact us</b> page via Apple Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class ContactUsApplePageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 114, testName = "Verify Contact Us Screen appears for Login via Apple", description = "Verify Contact Us Screen appears for Login via Apple")
	public void VerifyContactUs_LoginViaApple() throws InterruptedException, IOException
	{ 
