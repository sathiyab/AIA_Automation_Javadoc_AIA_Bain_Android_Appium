...
/**
 * This class contains test methods to test <b>Privacy policy</b> page via Email Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class PrivacyPolicyEmailPageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 239, testName = "Verify Privacy Statement Screen appears for Login via eMail", description = "Verify Privacy Statement Screen appears for Login via eMail")
	public void VerifyPrivacyStatement_LoginViaEmail() throws InterruptedException, IOException
	{ 
		ExtentReportManager.getTest().log(Status.INFO, "Verify Privacy Statement Screen appears for Login via eMail");
