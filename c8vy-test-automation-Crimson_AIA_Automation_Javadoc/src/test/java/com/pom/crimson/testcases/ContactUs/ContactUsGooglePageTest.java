...
/**
 * This class contains test methods to test <b>Contact us</b> page via Google Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class ContactUsGooglePageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 112, testName = "Verify Contact Us Screen appears for Login via Google", description = "Verify Contact Us Screen appears for Login via Google")
	public void VerifyContactUs_LoginViaGoogle() throws InterruptedException, IOException
	{ 
