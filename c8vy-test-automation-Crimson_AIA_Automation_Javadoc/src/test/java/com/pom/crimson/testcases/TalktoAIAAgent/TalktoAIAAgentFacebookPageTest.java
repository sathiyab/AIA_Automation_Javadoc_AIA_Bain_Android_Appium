...
/**
 * This class contains test methods to test <b>Talk to AIA agent</b> Page via Facebook Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class TalktoAIAAgentFacebookPageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 139, testName = "Verify Talk to AIA Agent Screen appears for Login via Facebook for Select AIA Customer Yes With Email Option", description = "Verify Talk to AIA Agent Screen appears for Login via Facebook for Select AIA Customer Yes With Email Option")
	public void SubmitTalktoAIAAgentSelectAIACustomerYes_WithFacebookOption_LoginViaFacebook() throws InterruptedException, IOException
	{ 
		ExtentReportManager.getTest().log(Status.INFO, "Verify Talk to AIA Agent Screen appears for Login via Facebook");
	...
	@Test(enabled=true, priority = 140, testName = "Verify Talk to AIA Agent Screen appears for Login via Facebook for Select AIA Customer No With Email Option", description = "Verify Talk to AIA Agent Screen appears for Login via Facebook for Select AIA Customer No With Email Option")
	public void SubmitTalktoAIAAgentSelectAIACustomerNo_WithFacebookOption_LoginViaFacebook() throws InterruptedException, IOException
	{ 
		ExtentReportManager.getTest().log(Status.INFO, "Verify Talk to AIA Agent Screen appears for Login via Facebook");
		loginPage.Takepic_Recvideo();
		 if (loginPage.isElementDisplayed("Skip"))
	...
	@Test(enabled=true, priority = 141, testName = "Verify Talk to AIA Agent Screen appears for Login via Facebook for Select AIA Customer Yes With Phone Option", description = "Verify Talk to AIA Agent Screen appears for Login via Facebook for Select AIA Customer Yes With Phone Option")
	public void SubmitTalktoAIAAgentSelectAIACustomerYes_WithPhoneOption_LoginViaFacebook() throws InterruptedException, IOException
	{ 
		ExtentReportManager.getTest().log(Status.INFO, "Verify Talk to AIA Agent Screen appears for Login via Facebook");
		loginPage.Takepic_Recvideo();
		 if (loginPage.isElementDisplayed("Skip"))
	...
	@Test(enabled=true, priority = 142, testName = "Verify Talk to AIA Agent Screen appears for Login via Facebook for Select AIA Customer No With Phone Option", description = "Verify Talk to AIA Agent Screen appears for Login via Facebook for Select AIA Customer No With Phone Option")
	public void SubmitTalktoAIAAgentSelectAIACustomerNo_WithPhoneOption_LoginViaFacebook() throws InterruptedException, IOException
	{ 
		ExtentReportManager.getTest().log(Status.INFO, "Verify Talk to AIA Agent Screen appears for Login via Facebook");
		loginPage.Takepic_Recvideo();
		 if (loginPage.isElementDisplayed("Skip"))
