...
/**
 * This class contains test methods to test <b>Logout</b> functionality via Facebook Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class LogoutFacebookPageTest extends BaseFixture{
	...
	@Test(enabled=true, priority = 253, testName = "Verify Log out with Facebook", description = "Verify Log out with Facebook")
	public void VerifyLogoutviaFacebook() throws Exception
	{
		...
		logAssert.assertTrue(loginPage.isElementDisplayed("Continue with Facebook"),"Continue with Facebook option appears in Login or Sign up screens");
