...
/**
 * This class contains test methods to test <b>NPS</b> functionality via Apple Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class NPSApplePageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 160, testName = "Verify NPS for (Scale 1 -6) Login via Apple", description = "Verify NPS for (Scale 1 -6) Login via Apple")
	public void VerifyNPS_Scale1to6_LoginViaApple() throws InterruptedException, IOException
	{ 
	ExtentReportManager.getTest().log(Status.INFO, "Verify NPS appears for Login via Apple");
	...
	@Test(enabled=true, priority = 161, testName = "Verify NPS for (Scale 7 -8) Login via Apple", description = "Verify NPS for (Scale 7 -8) Login via Apple")
	public void VerifyNPS_Scale7to8_LoginViaApple() throws InterruptedException, IOException
	{ 
		ExtentReportManager.getTest().log(Status.INFO, "Verify NPS appears for Login via Apple");
		loginPage.Takepic_Recvideo();
		 if (loginPage.isElementDisplayed("Skip"))
	...
	@Test(enabled=true, priority = 162, testName = "Verify NPS for (Scale 9 -10) Login via Apple", description = "Verify Contact Us Screen appears for Login via Apple")
	public void VerifyNPS_Scale9to10_LoginViaApple() throws InterruptedException, IOException
	{
		ExtentReportManager.getTest().log(Status.INFO, "Verify NPS appears for Login via Apple");
		loginPage.Takepic_Recvideo();
		 if (loginPage.isElementDisplayed("Skip"))
