...
/**
 * This class contains test methods to test <b>Talk to AIA agent</b> Page via Email Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class TalktoAIAAgentEmailPageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 135, testName = "Verify Talk to AIA Agent Screen appears for Login via Email for Select AIA Customer Yes With Email Option", description = "Verify Talk to AIA Agent Screen appears for Login via Email for Select AIA Customer Yes With Email Option")
	...
	@Test(enabled=true, priority = 136, testName = "Verify Talk to AIA Agent Screen appears for Login via Email for Select AIA Customer No With Email Option", description = "Verify Talk to AIA Agent Screen appears for Login via Email for Select AIA Customer No With Email Option")
	...
	@Test(enabled=true, priority = 137, testName = "Verify Talk to AIA Agent Screen appears for Login via Email for Select AIA Customer Yes With Phone Option", description = "Verify Talk to AIA Agent Screen appears for Login via Email for Select AIA Customer Yes With Phone Option")
	...
	@Test(enabled=true, priority = 138, testName = "Verify Talk to AIA Agent Screen appears for Login via Email for Select AIA Customer No With Phone Option", description = "Verify Talk to AIA Agent Screen appears for Login via Email for Select AIA Customer No With Phone Option")
