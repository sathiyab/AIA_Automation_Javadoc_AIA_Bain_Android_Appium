...
/**
 * This class contains test methods to test <b>Feature Rating</b> functionality via Facebook Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class FeatureRatingDemoFacebookPageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 173, testName = "Verify Feature rating demo via facebook", description = "Verify Feature rating demo via Email")
	public void verifyFeatureRatingLoginWithFacebook() throws Exception
	{
	...
	@Test(enabled=true, priority = 174, testName = "Verify Feature rating demo with Not Now option via Facebook", description = "Verify Feature rating demo with Not Now option via Email")
	public void verifyFeatureRatingLogin_NotNow_WithFacebook() throws Exception
	{
			loginPage.Takepic_Recvideo();
			loginPage.skipIntroScreens();
			loginPage.LoginWithFacebook();
