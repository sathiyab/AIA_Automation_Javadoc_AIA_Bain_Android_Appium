...
/**
 * This class contains test methods to test Menus in Profile screen via Email Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class AccountEmailPageTest extends BaseFixture {
	LoginPage loginPage;
	HomePage homePage;
	LogAssert logAssert;
	...
	@Test(enabled=true, priority = 81, testName = "Verify all the menus are working in Account screen via Email", description = "Verify all the menus are working in Account screen via Email")
	public void VerifyManusInAccountScreenviaEmail() throws InterruptedException, IOException
	{ 
    ...
    //logAssert.assertTrue(CP.isElementDisplayed("Languages"),"Languages screen appears");
    //CP.BackButton();
    MP.clickProfile();
	...
	@Test(enabled=true, priority = 81, testName = "Verify all the menus are working in Account screen via Email", description = "Verify all the menus are working in Account screen via Email")
       ...
       FAQsPage FP=new FAQsPage(getDriver(), getPlatformName());
        ...
        {
        	 logAssert.assertTrue(TU.isElementDisplayed("Terms of Use"),"Terms of Use information is available");
        }
        MP.clickProfile();
        LogoutPage LP=new LogoutPage (getDriver(), getPlatformName());
        LP.VerifyLogoutExists();
