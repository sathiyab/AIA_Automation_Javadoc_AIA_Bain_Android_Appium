...
/**
 * This class contains test methods to test <b>NPS</b> functionality via Facebook Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class NPSFacebookPageTest extends BaseFixture {
	...
	@Test(enabled=true, priority = 154, testName = "Verify NPS for (Scale 1 -6) Login via Facebook", description = "Verify NPS for (Scale 1 -6) Login via Facebook")
	public void VerifyNPS_Scale1to6_LoginViaFacebook() throws InterruptedException, IOException
	{ 
	ExtentReportManager.getTest().log(Status.INFO, "Verify NPS appears for Login via Facebook");
	...
	@Test(enabled=true, priority = 155, testName = "Verify NPS for (Scale 7 -8) Login via Facebook", description = "Verify NPS for (Scale 7 -8) Login via Facebook")
	public void VerifyNPS_Scale7to8_LoginViaFacebook() throws InterruptedException, IOException
	{ 
		ExtentReportManager.getTest().log(Status.INFO, "Verify NPS appears for Login via Facebook");
		loginPage.Takepic_Recvideo();
		 if (loginPage.isElementDisplayed("Skip"))
	...
	@Test(enabled=true, priority = 156, testName = "Verify NPS for (Scale 9 -10) Login via Facebook", description = "Verify Contact Us Screen appears for Login via Facebook")
	public void VerifyNPS_Scale9to10_LoginViaFacebook() throws InterruptedException, IOException
	{
		ExtentReportManager.getTest().log(Status.INFO, "Verify NPS appears for Login via Facebook");
		loginPage.Takepic_Recvideo();
		 if (loginPage.isElementDisplayed("Skip"))
