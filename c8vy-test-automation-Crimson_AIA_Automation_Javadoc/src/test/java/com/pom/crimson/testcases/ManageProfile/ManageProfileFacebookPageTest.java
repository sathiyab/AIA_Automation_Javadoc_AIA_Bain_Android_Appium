...
/**
 * This class contains test methods to test <b>Manage profile</b> functionality via Facebook Login 
 * 
 * @author Balaji.Sridharan 
 */	
public class ManageProfileFacebookPageTest extends BaseFixture {
	LoginPage loginPage;
	HomePage homePage;
	LogAssert logAssert;
...
@Test(enabled=true, priority = 181, testName = "Verify switching from \"We are planning to have a baby\" to \"We are pregnant flow\" via Facebook login", description = "Verify switching from \"We are planning to have a baby\" to \"We are pregnant flow\" with No Option via Facebook login")
public void SwitchArchetype_PHB_PRG_viaFacebook() throws InterruptedException, IOException
{ 
...
@Test(enabled=true, priority = 182, testName =" Verify switching from \"My partner and I are Pregnant\" to \"I have a new born\"via Facebook", description = "Verify switching from \"My partner and I are Pregnant\" to \"I have a new born\"via Facebook")
public void SwitchArchetype_PRG_NB_viaFacebook() throws InterruptedException, IOException
{
 loginPage.Takepic_Recvideo();
...
logAssert.assertAll();
 ...
 @Test(enabled=true, priority = 183, testName =" Verify switching from \"I have a new born\" to \"I have a child/children\"via Facebook", description = " Verify switching from \"I have a new born\" to \"I have a child/children\"via Facebook")
public void SwitchArchetyped_NB_to_CC_viaFacebook() throws InterruptedException, IOException
{
	 loginPage.Takepic_Recvideo();
...
MP.ClickDone();
logAssert.assertTrue(MP.isElementDisplayed("I have a child/children (older than 1 year old)"),"I have a child/children (older than 1 year old) flow is loaded.");
MP.clickProfile();
LogoutPage LP=new LogoutPage (getDriver(), getPlatformName());
LP.VerifyLogoutExists();
logAssert.assertTrue(LP.isElementDisplayed("Log out"),"Log out is displayed");
...
logAssert.assertAll();
 ...
 @Test(enabled=true, priority = 184, testName ="Verify switching from I have a child children to We are planning to have a baby via Facebook", description = "Verify switching from \"My partner and I are Pregnant\" to \"I have a new born\"via Facebook")
	public void SwitchArchetyped_CC_to_PHB_viaFacebook() throws InterruptedException, IOException
	{
	 loginPage.Takepic_Recvideo();
 ...
 @Test(enabled=true, priority = 185, testName = "Verify Update Archetype for We are planning to have a baby via Facebook", description = "Verify Update Archetype for We are planning to have a baby via Facebook")
	public void PHBUpdateArchetypedMaleFlowviaFacebook() throws InterruptedException, IOException
	{ 
	loginPage.Takepic_Recvideo();
